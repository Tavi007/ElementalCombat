...
public class WeaknessParticleData implements IParticleData {

	private Color tint;
	private double diameter;


	public WeaknessParticleData(Color tint, double diameter) {
		this.tint = tint;
	...
	@Nonnull
	@Override
	public ParticleType<WeaknessParticleData> getType() {
		return StartupCommon.weaknessParticleType;
	}
	...
	public static final IDeserializer<WeaknessParticleData> DESERIALIZER = new IDeserializer<WeaknessParticleData>() {

		// parse the parameters for this particle from a /particle command
		@Nonnull
		@Override
		public WeaknessParticleData deserialize(@Nonnull ParticleType<WeaknessParticleData> type, @Nonnull StringReader reader) throws CommandSyntaxException {
			reader.expect(' ');
			...
			return new WeaknessParticleData(color, diameter);
		}

		// read the particle information from a PacketBuffer after the client has received it from the server
		@Override
		public WeaknessParticleData read(@Nonnull ParticleType<WeaknessParticleData> type, PacketBuffer buf) {
