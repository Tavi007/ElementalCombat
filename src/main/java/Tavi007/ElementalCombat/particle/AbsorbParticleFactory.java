...
public class AbsorbParticleFactory implements IParticleFactory<AbsorbParticleData> {  //IParticleFactory
	...
	public AbsorbParticleFactory(IAnimatedSprite sprite) {
		this.sprites = sprite;
	}
