...
public class WeaknessParticleFactory implements IParticleFactory<WeaknessParticleData> {  //IParticleFactory
	...
	public WeaknessParticleFactory(IAnimatedSprite sprite) {
		this.sprites = sprite;
	}
	...
	private WeaknessParticleFactory() {
