...
public class ResistanceParticleFactory implements IParticleFactory<ResistanceParticleData> {  //IParticleFactory
	...
	public ResistanceParticleFactory(IAnimatedSprite sprite) {
		this.sprites = sprite;
	}
	...
	private ResistanceParticleFactory() {
