...
public class ResistanceParticleData implements IParticleData {

	private Color tint;
	private double diameter;


	public ResistanceParticleData(Color tint, double diameter) {
		this.tint = tint;
	...
	@Nonnull
	@Override
	public ParticleType<ResistanceParticleData> getType() {
		return StartupCommon.resistanceParticleType;
	}
	...
	public static final IDeserializer<ResistanceParticleData> DESERIALIZER = new IDeserializer<ResistanceParticleData>() {

		// parse the parameters for this particle from a /particle command
		@Nonnull
		@Override
		public ResistanceParticleData deserialize(@Nonnull ParticleType<ResistanceParticleData> type, @Nonnull StringReader reader) throws CommandSyntaxException {
			reader.expect(' ');
			...
			return new ResistanceParticleData(color, diameter);
		}

		// read the particle information from a PacketBuffer after the client has received it from the server
		@Override
		public ResistanceParticleData read(@Nonnull ParticleType<ResistanceParticleData> type, PacketBuffer buf) {
