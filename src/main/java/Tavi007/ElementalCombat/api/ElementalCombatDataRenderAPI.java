...
public class ElementalCombatDataRenderAPI {
    ...
    public static void renderTextAndIcons(PoseStack poseStack,
            int x,
            int y,
        ...
        AttackLayer attackLayer = AttackDataAPI.getFullDataAsLayer(stack);
        DefenseLayer defenseLayer = DefenseDataAPI.getFullDataAsLayer(stack);
        renderTextAndIcons(poseStack, x, y, showDoubleRowDefense, attackLayer, defenseLayer);
    }
    ...
    public static void renderTextAndIcons(PoseStack poseStack,
        ...
        clientComponent.renderText(mc.font,
            ...
            x,
            y); // nullpointer here
        clientComponent.renderImage(mc.font, x, y, poseStack, null, 0);
    }
}
