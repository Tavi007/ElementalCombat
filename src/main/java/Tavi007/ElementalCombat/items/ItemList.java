...
public class ItemList {
	...
	public static final RegistryObject<Item> ELEMENTAL_SWORD = ITEMS.register("elemental_sword", () -> new ElementalSword(ItemTier.IRON, 5, 2.0f, new Item.Properties().group(ItemGroup.COMBAT)));
