...
public class ItemList {
	...
	public static final RegistryObject<Item> NIGHTVISION_GOOGLES	= ITEMS.register("nightvision_googles", () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.HEAD, singleStack));
	...
	public static final RegistryObject<Item> COOLING_LEGGINGS 		= ITEMS.register("cooling_leggings", () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.LEGS, singleStack));
	...
	public static final RegistryObject<Item> HEAVY_BOOTS			= ITEMS.register("heavy_boots", () -> new MirrorArmor(ArmorMaterial.MIRROR, EquipmentSlotType.FEET, singleStack));
