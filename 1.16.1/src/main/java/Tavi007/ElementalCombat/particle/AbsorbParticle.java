...
public class AbsorbParticle extends SpriteTexturedParticle{

	private final IAnimatedSprite sprites;  
	
	public AbsorbParticle(ClientWorld world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<AbsorbParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(AbsorbParticleData combatParticleData, ClientWorld world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
			AbsorbParticle newParticle = new AbsorbParticle(world, xPos, yPos, zPos, xVelocity, yVelocity, zVelocity,
