...
public class WeaknessParticle extends SpriteTexturedParticle{

	private final IAnimatedSprite sprites;  

	public WeaknessParticle(ClientWorld world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<WeaknessParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(WeaknessParticleData combatParticleData, ClientWorld world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
			WeaknessParticle newParticle = new WeaknessParticle(world, xPos, yPos, zPos, xVelocity, yVelocity, zVelocity,
