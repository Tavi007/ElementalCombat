...
public class AbsorbParticle extends SpriteTexturedParticle{
	...
	public AbsorbParticle(World world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<AbsorbParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(AbsorbParticleData combatParticleData, World world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
