...
public class ResistanceParticle extends SpriteTexturedParticle{
	...
	public ResistanceParticle(World world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<ResistanceParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(ResistanceParticleData combatParticleData, World world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
