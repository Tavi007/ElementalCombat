...
public class ImmunityParticle extends SpriteTexturedParticle{
	...
	public ImmunityParticle(World world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<ImmunityParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(ImmunityParticleData combatParticleData, World world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
