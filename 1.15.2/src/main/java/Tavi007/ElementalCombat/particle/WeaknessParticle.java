...
public class WeaknessParticle extends SpriteTexturedParticle{
	...
	public WeaknessParticle(World world, double x, double y, double z,
	...
	public static class Factory implements IParticleFactory<WeaknessParticleData> {  //IParticleFactory
		...
		@Nullable
		//@Override
		public Particle makeParticle(WeaknessParticleData combatParticleData, World world, double xPos, double yPos, double zPos, double xVelocity, double yVelocity, double zVelocity) {
